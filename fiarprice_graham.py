...
- **استخدام ربحية السهم المستقبلية:**
  إذا كانت هناك قيمة مستقبلية لربحية السهم متاحة في مكتبة ياهو فايننس، فإن البرنامج سيستخدمها لحساب القيمة العادلة. في حال عدم توفرها، سيستخدم البرنامج القيمة الأخيرة المتاحة.
